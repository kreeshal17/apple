                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">Amazing Quality and Performance!" "I absolutely love this product! The quality exceeded my expectations, and the performance is top-notch. It works seamlessly, and I couldn't be happier with my purchase. Highly recommend to anyone looking for something reliable and well-made!.</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">This product is exactly what I needed! It's easy to use, very durable, and does exactly what I expected. I'm really impressed with the value for money. It’s definitely become an essential part of my daily routine. Will definitely buy from here again!.</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">"I had a great experience from start to finish. The product arrived on time, well-packaged, and in perfect condition. The quality is outstanding, and it's even better than I thought it would be. Customer service was also amazing—helpful and quick to respond. Very happy with my purchase!".</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Rajesh Thapa</h2>
